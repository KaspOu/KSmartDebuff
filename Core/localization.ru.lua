...
SMARTDEBUFF_OFT_COLTEXTURE     = "Текстура"
...
SMARTDEBUFF_OFT_SHOWSPELLICON  = "Иконки заклинаний";
...
SMARTDEBUFF_TT_SHOWSPELLICON   = "Показывает иконки HoT\nна юните.";
...
SMARTDEBUFF_TT_RELOADREQUIRED   = "Требуется перезагрузка интерфейса (напишите /reload)"
SMARTDEBUFF_TT_DISABLED_VERSION  = "Эта опция недоступна в этой версии WoW."
SMARTDEBUFF_TT_DISABLED_BLIZZARD = "Эта опция больше недоступна из-за ограничений Blizzard."
SMARTDEBUFF_TT_COLTEXTURE       = "Задать текстуру значка\n(используйте тестовый режим для предпросмотра)\n"
