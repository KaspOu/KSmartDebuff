...
SMARTDEBUFF_OFT_COLTEXTURE     = "Trama"
...
SMARTDEBUFF_TT_RELOADREQUIRED   = "\195\136 richiesto un ricaricamento (scrivi /reload)"
...
SMARTDEBUFF_TT_COLTEXTURE       = "Imposta la trama dell'icona\n(usa la modalit\195\160 test per l'anteprima)\n"
