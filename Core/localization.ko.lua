...
SMARTDEBUFF_OFT_COLTEXTURE     = "텍스처"
...
SMARTDEBUFF_OFT_SHOWSPELLICON  = "주문 아이콘들 표시";
...
SMARTDEBUFF_TT_RELOADREQUIRED   = "재시작이 필요합니다 (/reload 입력)"
...
SMARTDEBUFF_TT_COLTEXTURE       = "아이콘 텍스처 설정\n(미리보려면 테스트 모드 사용)\n"
