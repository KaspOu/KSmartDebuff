...
SMARTDEBUFF_OFT_SHOWSPELLICON  = "法術圖標們";  -- ChatGPT
...
SMARTDEBUFF_TT_SHOWSPELLICON   = "在單位上顯示持續治療 (HoT) 圖標們。";  -- ChatGPT
